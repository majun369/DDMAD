...
if __name__ == '__main__':
    ...
    parser.add_argument('--np', type=float, default=2.0)
    parser.add_argument('--fp', type=float, default=2.0)
    ...
    parser.add_argument('--model_save_path', type=str, default='checkpoints/SMAP')
    parser.add_argument('--patch_size_list', nargs='+', type=int, default=[[16, 12, 8, 32], [12, 8, 6, 4], [8, 6, 4, 2]])

    parser.add_argument('--anormly_ratio', type=float, default=0.85)
